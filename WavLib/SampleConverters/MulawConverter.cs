...
/// <summary>
/// A converter for Mulaw-encoded audio data
/// </summary>
public class MulawConverter : IConverter
{
    /// <summary>
    ...
    private static float ConvertSample(BinaryReader stream, int bytesPerSample)
    {
        ...
        if (2 == bytesPerSample)
        {
            value = Ulaw2Lpcm[stream.ReadByte()];
            maxValue = short.MaxValue;
        }
        return value / maxValue;
    }

    private static short UlawBias = 0x84;
    private static short UlawClip = 0x7F7B;
	...
	private static short[] Ulaw2Lpcm = new short[256] {
